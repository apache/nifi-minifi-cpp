...
class LibarchiveConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.options.with_openssl:
            ...
            self.requires("openssl/3.3.0@minifi/dev") # note: need to figure how to integrate openssl conan with libarchive; think libarchive needs a patch
        ...
        if self.options.with_lzma:
            ...
            self.requires("xz_utils/5.2.5@minifi/dev")
    ...
    def generate(self):
        ...
        if not self.options.shared:
            tc.variables["LIBARCHIVE_STATIC"] = "1"
    ...
    def package_info(self):
        ...
        if is_msvc(self) and not self.options.shared:
            ...
            self.cpp_info.defines = ["LIBARCHIVE_STATIC=1"]
