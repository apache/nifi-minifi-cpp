...
class XZUtilsConan(ConanFile):
    ...
    def generate(self):
        if is_msvc(self):
            ...
            tc.configure_args.append("--disable-xz")
            tc.configure_args.append("--disable-xzdec")
            tc.configure_args.append("--disable-lzmadec")
            tc.configure_args.append("--disable-lzmainfo")
            tc.configure_args.append("--disable-lzma-links")
            tc.configure_args.append("--disable-scripts")
            tc.configure_args.append("--enable-shared=no")
            if self.options.portable:
                tc.configure_args.append("--disable-assembler")
