...
class MBedTLSConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["libmbedtls"].set_property("cmake_target_name", "mbedTLS::mbedtls")
        self.cpp_info.components["libmbedtls"].libs = ["mbedtls"]
        self.cpp_info.components["libmbedtls"].requires = ["mbedx509"]
        if Version(self.version) >= "3.6.0":
            self.cpp_info.components["libmbedtls"].set_property("pkg_config_name", "mbedtls")
        ...
        self.cpp_info.components["libmbedtls"].names["cmake_find_package"] = "mbedtls"
        self.cpp_info.components["libmbedtls"].names["cmake_find_package_multi"] = "mbedtls"
