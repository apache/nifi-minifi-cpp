...
class ProcessContext : public virtual core::VariableRegistry, public virtual utils::EnableSharedFromThis {
 public:
  ...
  // Locally creates a StateManager instance, commiting or rolling back changes to the component state is the responsibility of the caller.
  ...
  // The ProcessSession is responsible for commiting or rolling back any changes to the component state at the end of the onTrigger execution.
