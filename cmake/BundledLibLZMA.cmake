...
function(use_bundled_liblzma SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt LibLZMA external lib")
        include(${CMAKE_BINARY_DIR}/LibLZMAConfig.cmake)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building LibLZMA external lib")

        # Define patch step
        if (WIN32)
            set(PC "${Patch_EXECUTABLE}" -p1 -i "${SOURCE_DIR}/thirdparty/liblzma/xz_utils/all/patches/liblzma.patch")
        endif()
