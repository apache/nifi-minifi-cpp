...
function(use_bundled_libcoap SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        ...
        set(COAP_LIBRARIES "${libcoap_LIBRARIES}" CACHE STRING "" FORCE)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building LibCoap external lib")

        # Define patch step
        if (WIN32)
            set(PC "${Patch_EXECUTABLE}" -p1 -i "${SOURCE_DIR}/thirdparty/libcoap/all/patches/libcoap-windows-cmake.patch")
        endif()
