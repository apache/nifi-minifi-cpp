...
function(use_bundled_bzip2 SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        ...
        include(${CMAKE_BINARY_DIR}/BZip2Config.cmake)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building BZip2 external lib")


        # Define patch step
        set(PC "${Patch_EXECUTABLE}" -p1 -i "${SOURCE_DIR}/thirdparty/bzip2/all/patches/bzip2.patch")
