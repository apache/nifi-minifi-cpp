...
function(use_bundled_libssh2 SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt LibSSH2 external lib")
        include(${CMAKE_BINARY_DIR}/Libssh2Config.cmake)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building LibSSH2 external lib")
