...
set(WEBSOCKETS_PATCH_FILE_3 "${CMAKE_SOURCE_DIR}/thirdparty/libwebsockets/enum-int.patch")
set(WEBSOCKETS_PC ${Bash_EXECUTABLE} -c "set -x &&\
        ...
        (${Patch_EXECUTABLE} -R -p1 -s -f --dry-run -i ${WEBSOCKETS_PATCH_FILE_3} || ${Patch_EXECUTABLE} -p1 -i ${WEBSOCKETS_PATCH_FILE_3}) ")
