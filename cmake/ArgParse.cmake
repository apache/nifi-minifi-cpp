...
if(USE_CONAN_PACKAGER)
    message("FAST: Using Conan Packager to manage installing prebuilt ArgParse external lib")
    include(${CMAKE_BINARY_DIR}/argparse-config.cmake)
elseif(USE_CMAKE_FETCH_CONTENT)
    message("SLOW: Using CMAKE's FetchContent to manage source building ArgParse external lib")
