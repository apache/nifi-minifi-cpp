...
function(use_bundled_mbedtls SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt MbedTLS external lib")
        include(${CMAKE_BINARY_DIR}/mbedTLSConfig.cmake)

        
    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's FetchContent to manage source building MbedTLS external lib")
