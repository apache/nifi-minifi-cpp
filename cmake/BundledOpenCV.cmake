...
function(use_bundled_opencv SOURCE_DIR BINARY_DIR)
    ...
    set(BYPRODUCTS
        ...
        "${OPENCV_BYPRODUCT_DIR}/${CMAKE_INSTALL_LIBDIR}/opencv4/3rdparty/${PREFIX}libjpeg-turbo.${SUFFIX}"
        "${OPENCV_BYPRODUCT_DIR}/${CMAKE_INSTALL_LIBDIR}/opencv4/3rdparty/${PREFIX}libpng.${SUFFIX}")
    ...
    set_target_properties(OPENCV::libjpeg-turbo PROPERTIES IMPORTED_LOCATION "${OPENCV_BYPRODUCT_DIR}/${CMAKE_INSTALL_LIBDIR}/opencv4/3rdparty/${PREFIX}libjpeg-turbo.${SUFFIX}")
    add_dependencies(OPENCV::libjpeg-turbo opencv-external)

    add_library(OPENCV::libpng STATIC IMPORTED)
    set_target_properties(OPENCV::libpng PROPERTIES IMPORTED_LOCATION "${OPENCV_BYPRODUCT_DIR}/${CMAKE_INSTALL_LIBDIR}/opencv4/3rdparty/${PREFIX}libpng.${SUFFIX}")
