...
function(use_bundled_opencv SOURCE_DIR BINARY_DIR)
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt OpenCV external lib")
        include(${CMAKE_BINARY_DIR}/OpenCVConfig.cmake)

        add_library(OPENCV::libopencv ALIAS opencv::opencv)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building OpenCV external lib")
