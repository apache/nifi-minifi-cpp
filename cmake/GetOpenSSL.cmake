...
if(MINIFI_OPENSSL_SOURCE STREQUAL "CONAN")
    ...
    set(OPENSSL_BIN_DIR "${openssl_PACKAGE_FOLDER_${OPENSSL_CONAN_CONFIG}}" CACHE STRING "" FORCE)

    find_package(openssl-fips REQUIRED)
    set(OPENSSL_FIPS_BIN_DIR "${openssl-fips_PACKAGE_FOLDER_${OPENSSL_CONAN_CONFIG}}" CACHE STRING "" FORCE)
