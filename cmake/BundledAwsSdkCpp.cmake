...
function(use_bundled_libaws SOURCE_DIR BINARY_DIR)
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt aws-sdk-cpp external lib")
        include(${CMAKE_BINARY_DIR}/AWSSDKConfig.cmake)

    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's FetchContent to manage source building aws-sdk-cpp external lib")
