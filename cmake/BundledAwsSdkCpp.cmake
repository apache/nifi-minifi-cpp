...
function(use_bundled_libaws SOURCE_DIR BINARY_DIR)
    ...
    if (NOT WIN32 AND NOT APPLE)
        target_link_libraries(AWS::aws-c-io INTERFACE AWS::s2n)
    endif()
    ...
    if (APPLE)
        target_link_libraries(AWS::aws-cpp-sdk-core INTERFACE "-framework CoreFoundation")
    endif()
    if (WIN32)
        target_link_libraries(AWS::aws-cpp-sdk-core INTERFACE userenv.lib ws2_32.lib Wininet.lib winhttp.lib bcrypt.lib version.lib)
    endif()
