...
function(use_bundled_libsodium SOURCE_DIR BINARY_DIR)
    ...
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt libsodium external lib")
        include(${CMAKE_BINARY_DIR}/libsodium-config.cmake)
        # find_package(libsodium REQUIRED CONFIG)
        message("Conan libsodium include dir: ${libsodium_INCLUDE_DIRS}")
