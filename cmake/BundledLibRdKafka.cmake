...
function(use_bundled_librdkafka SOURCE_DIR BINARY_DIR)
    message("Using bundled librdkafka")

    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt LibRdKafka external lib")
        include(${CMAKE_BINARY_DIR}/RdKafkaConfig.cmake)

        set(LIBRDKAFKA_INCLUDE_DIR "${RdKafka_INCLUDE_DIRS}/librdkafka" CACHE STRING "" FORCE)
        set_property(TARGET RdKafka::rdkafka++ APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${LIBRDKAFKA_INCLUDE_DIR})

        add_library(librdkafka ALIAS RdKafka::rdkafka++)


    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's ExternalProject_Add to manage source building LibRdKafka external lib")
