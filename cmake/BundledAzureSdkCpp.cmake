...
function(use_bundled_libazure SOURCE_DIR BINARY_DIR)
    ...
    set_property(TARGET AZURE::azure-core APPEND PROPERTY INTERFACE_LINK_LIBRARIES LibXml2::LibXml2 CURL::libcurl OpenSSL::Crypto OpenSSL::SSL Threads::Threads nlohmann_json::nlohmann_json)
    if (APPLE)
        set_property(TARGET AZURE::azure-core APPEND PROPERTY INTERFACE_LINK_LIBRARIES "-framework CoreFoundation")
    endif()
    if (WIN32)
        set_property(TARGET AZURE::azure-core APPEND PROPERTY INTERFACE_LINK_LIBRARIES winhttp.lib)
    endif()
    ...
    set_property(TARGET AZURE::azure-identity APPEND PROPERTY INTERFACE_LINK_LIBRARIES LibXml2::LibXml2 CURL::libcurl OpenSSL::Crypto OpenSSL::SSL Threads::Threads nlohmann_json::nlohmann_json)
    if (APPLE)
        set_property(TARGET AZURE::azure-identity APPEND PROPERTY INTERFACE_LINK_LIBRARIES "-framework CoreFoundation")
    endif()
    if (WIN32)
        set_property(TARGET AZURE::azure-identity APPEND PROPERTY INTERFACE_LINK_LIBRARIES winhttp.lib)
    endif()
    ...
    set_property(TARGET AZURE::azure-storage-common APPEND PROPERTY INTERFACE_LINK_LIBRARIES LibXml2::LibXml2 CURL::libcurl OpenSSL::Crypto OpenSSL::SSL Threads::Threads nlohmann_json::nlohmann_json)
    if (APPLE)
        set_property(TARGET AZURE::azure-storage-common APPEND PROPERTY INTERFACE_LINK_LIBRARIES "-framework CoreFoundation")
    endif()
    if (WIN32)
        set_property(TARGET AZURE::azure-storage-common APPEND PROPERTY INTERFACE_LINK_LIBRARIES winhttp.lib)
    endif()
    ...
    set_property(TARGET AZURE::azure-storage-blobs APPEND PROPERTY INTERFACE_LINK_LIBRARIES LibXml2::LibXml2 CURL::libcurl OpenSSL::Crypto OpenSSL::SSL Threads::Threads nlohmann_json::nlohmann_json)
    if (APPLE)
        set_property(TARGET AZURE::azure-storage-blobs APPEND PROPERTY INTERFACE_LINK_LIBRARIES "-framework CoreFoundation")
    endif()
    if (WIN32)
        set_property(TARGET AZURE::azure-storage-blobs APPEND PROPERTY INTERFACE_LINK_LIBRARIES winhttp.lib)
    endif()
