...
function(use_bundled_yamlcpp SOURCE_DIR BINARY_DIR)
    if(USE_CONAN_PACKAGER)
        message("Using Conan Packager to manage installing prebuilt yaml-cpp external lib")
        include(${CMAKE_BINARY_DIR}/yaml-cpp-config.cmake)
    elseif(USE_CMAKE_FETCH_CONTENT)
        message("Using CMAKE's FetchContent to manage source building yaml-cpp external lib")
