...
function(createTests testName)
    ...
    target_link_libraries(${testName} core-minifi yaml-cpp::yaml-cpp spdlog Threads::Threads Catch2::Catch2WithMain)
...
target_link_libraries(${TEST_BASE_LIB} core-minifi Catch2::Catch2WithMain)
...
if(NOT WIN32 AND ENABLE_NANOFI)
    ...
    FOREACH(testfile ${NANOFI_UNIT_TESTS})
        ...
        target_link_libraries(${testfilename} Catch2::Catch2WithMain Threads::Threads)
...
target_link_libraries(OnScheduleErrorHandlingTests minifi-test-processors Catch2::Catch2WithMain)
