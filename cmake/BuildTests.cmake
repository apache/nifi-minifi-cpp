...
function(createTests testName)
   message ("-- Adding test: ${testName}")
    ...
    target_include_directories(${testName} BEFORE PRIVATE "${CMAKE_SOURCE_DIR}/thirdparty/civetweb-1.10/include")
...
target_include_directories(${TEST_BASE_LIB} BEFORE PRIVATE "${CMAKE_SOURCE_DIR}/thirdparty/civetweb-1.10/include")
