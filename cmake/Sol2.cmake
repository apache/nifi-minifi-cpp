...
if(USE_CONAN_PACKAGER)
    message("Using Conan Packager to manage installing prebuilt Sol2 external lib")
    include(${CMAKE_BINARY_DIR}/sol2-config.cmake)
elseif(USE_CMAKE_FETCH_CONTENT)
    message("Using CMAKE's file DOWNLOAD to manage integrating Sol2 external lib")
