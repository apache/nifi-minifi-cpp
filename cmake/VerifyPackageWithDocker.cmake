...
CREATE_DOCKER_TARGET_FROM_ROCKY_PACKAGE(rockylinux:8 rocky8 "dnf install -y wget python3.12-devel python3.12-pip gcc gcc-c++ findutils libatomic \\&\\& alternatives --install /usr/bin/python3 python3 /usr/bin/python3.12 2 \\&\\& alternatives --set python3 /usr/bin/python3.12")
CREATE_DOCKER_TARGET_FROM_ROCKY_PACKAGE(rockylinux:9 rocky9 "dnf install -y wget python3.12-devel python3.12-pip gcc gcc-c++ findutils libatomic \\&\\& alternatives --install /usr/bin/python3 python3 /usr/bin/python3.12 2 \\&\\& alternatives --set python3 /usr/bin/python3.12")
...
CREATE_DOCKER_TARGET_FROM_RPM_PACKAGE(rockylinux:8 rocky8 "dnf install -y wget python3.12-devel python3.12-pip gcc gcc-c++ findutils libatomic \\&\\& alternatives --install /usr/bin/python3 python3 /usr/bin/python3.12 2 \\&\\& alternatives --set python3 /usr/bin/python3.12")
CREATE_DOCKER_TARGET_FROM_RPM_PACKAGE(rockylinux:9 rocky9 "dnf install -y wget python3.12-devel python3.12-pip gcc gcc-c++ findutils libatomic \\&\\& alternatives --install /usr/bin/python3 python3 /usr/bin/python3.12 2 \\&\\& alternatives --set python3 /usr/bin/python3.12")
