...
function(use_bundled_osspuuid SOURCE_DIR BINARY_DIR)
    ...
    # Define patch step
    # Avoid failure and prompt in case already applied
    set(PC "${Patch_EXECUTABLE}" -p1 -N -i "${SOURCE_DIR}/thirdparty/ossp-uuid/ossp-uuid-mac-fix.patch" &&
           ...
           "${Patch_EXECUTABLE}" -p1 -R -i "${SOURCE_DIR}/thirdparty/ossp-uuid/ossp-uuid-mac-fix.patch" &&
           "${Patch_EXECUTABLE}" -p1 -R -i "${SOURCE_DIR}/thirdparty/ossp-uuid/ossp-uuid-no-prog.patch")
