...
@MINIFI_EXTENSION_ENRICHMENT @SUPPORTS_WINDOWS
Feature: ForkEnrichmentRs and JoinEnrichmentAttributesRs
  ...
  Scenario: Merges correctly
    ...
    And a ForkEnrichmentRs processor
    ...
    And the "success" relationship of the GenerateFlowFile processor is connected to the ForkEnrichmentRs
    And the "original" relationship of the ForkEnrichmentRs processor is connected to the JoinEnrichmentAttributesRs
    And the "enrichment" relationship of the ForkEnrichmentRs processor is connected to the ReplaceText
    And the "success" relationship of the ReplaceText processor is connected to the UpdateAttribute
    And the "success" relationship of the UpdateAttribute processor is connected to the JoinEnrichmentAttributesRs
    And the "joined" relationship of the JoinEnrichmentAttributesRs processor is connected to the LogAttribute
