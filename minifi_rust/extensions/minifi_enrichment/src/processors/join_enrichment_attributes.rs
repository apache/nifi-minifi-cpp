...
pub(crate) struct JoinEnrichmentAttributes {
    batch_size: usize,
...
impl MutTrigger for JoinEnrichmentAttributes {
...
mod tests {
    ...
    fn scheduled() -> (JoinEnrichmentAttributes, MockProcessContext, MockLogger) {
