...
| PGP                              | [EncryptContentPGP](PROCESSORS.md#encryptcontentpgp)<br/>[DecryptContentPGP](PROCESSORS.md#decryptcontentpgp)<br/>[PGPPublicKeyService](CONTROLLERS.md#pgppublickeyservice)<br/>[PGPPrivateKeyService](CONTROLLERS.md#pgpprivatekeyservice)                                                                                                                                                                                                                                                                                                                                                                                                     | -DMINIFI_EXTENSION_PGP=ON -DMINIFI_RUST=ON |
