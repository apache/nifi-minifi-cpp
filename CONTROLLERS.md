...
| **Name of Root Tag**        |               |                                                                       | Specifies the name of the XML root tag wrapping the record set. This property has to be set if the writer is supposed to write multiple records in a single FlowFile.                                                                                                                                                                                                                                                                                                                                                                                                   |
