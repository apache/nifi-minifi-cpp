...
int main(int argc, char **argv) {
  ...
  do {
    ...
    auto log_properties = std::make_shared<core::logging::LoggerProperties>(locations->log_properties_path_);
    ...
    //logger->log_info("MiNiFi Locations={}", locations->toString()); TODO(mzink)
