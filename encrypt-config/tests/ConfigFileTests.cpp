...
TEST_CASE("ConfigFile can test whether a key is present", "[encrypt-config][hasValue]") {
  ...
  REQUIRE(test_file.hasValue(org::apache::nifi::minifi::Configuration::nifi_c2_flow_id));  // present but blank
  REQUIRE(!test_file.hasValue(org::apache::nifi::minifi::Configuration::nifi_remote_input_secure));  // commented out
...
TEST_CASE("ConfigFile can read empty properties correctly", "[encrypt-config][constructor]") {
  ...
  auto empty_property = test_file.getValue(org::apache::nifi::minifi::Configuration::nifi_security_need_ClientAuth);
  REQUIRE(empty_property);
  REQUIRE(empty_property->empty());

  auto whitespace_property = test_file.getValue(org::apache::nifi::minifi::Configuration::nifi_security_client_certificate);  // value = " \t\r"
...
TEST_CASE("ConfigFile can find the value for a key", "[encrypt-config][getValue]") {
  ...
  SECTION("valid key") {
    REQUIRE(test_file.getValue(org::apache::nifi::minifi::Configuration::nifi_bored_yield_duration) == "10 millis");
  }
...
TEST_CASE("ConfigFile can update the value for a key", "[encrypt-config][update]") {
  ...
  SECTION("valid key") {
    test_file.update(org::apache::nifi::minifi::Configuration::nifi_bored_yield_duration, "20 millis");
    REQUIRE(test_file.getValue(org::apache::nifi::minifi::Configuration::nifi_bored_yield_duration) == "20 millis");
  }
...
TEST_CASE("ConfigFile can add a new setting after an existing setting", "[encrypt-config][insertAfter]") {
  ...
  SECTION("valid key") {
    test_file.insertAfter(org::apache::nifi::minifi::Configuration::nifi_rest_api_password, "nifi.rest.api.password.protected", "my-cipher-name");
...
TEST_CASE("ConfigFile can write to a new file", "[encrypt-config][writeTo]") {
  ...
  REQUIRE(test_file_copy.getValue(org::apache::nifi::minifi::Configuration::nifi_bored_yield_duration) == "20 millis");
}
...
TEST_CASE("ConfigFile can find the list of sensitive properties", "[encrypt-config][getSensitiveProperties]") {
  SECTION("default properties") {
    ConfigFile test_file{std::ifstream{"resources/minifi.properties"}};
    std::vector<std::string> expected_properties{org::apache::nifi::minifi::Configuration::nifi_rest_api_password};
  ...
  SECTION("with additional properties") {
    ...
    std::vector<std::string> expected_properties{
        org::apache::nifi::minifi::Configuration::nifi_c2_enable, org::apache::nifi::minifi::Configuration::nifi_flow_configuration_file,
        org::apache::nifi::minifi::Configuration::nifi_rest_api_password, org::apache::nifi::minifi::Configuration::nifi_security_client_pass_phrase};
    REQUIRE(test_file.getSensitiveProperties() == expected_properties);
  }
}
