...
class EncryptConfig {
 ...
 private:
  ...
  utils::crypto::EncryptionKeys getEncryptionKeys() const;
  ...
  void encryptSensitiveProperties(const utils::crypto::EncryptionKeys& encryption_key) const;

  const std::string minifi_home_;
  utils::crypto::EncryptionKeys keys_;
};
