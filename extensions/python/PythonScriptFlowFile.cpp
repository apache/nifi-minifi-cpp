...
PythonScriptFlowFile::PythonScriptFlowFile(std::shared_ptr<core::FlowFile> flow_file)
...
bool PythonScriptFlowFile::addAttribute(const std::string &key, const std::string &value) {
  if (!flow_file_) {
    throw std::runtime_error("Access of FlowFile after it has been released");
  }
...
bool PythonScriptFlowFile::setAttribute(const std::string &key, const std::string &value) {
  if (!flow_file_) {
    throw std::runtime_error("Access of FlowFile after it has been released");
  }
