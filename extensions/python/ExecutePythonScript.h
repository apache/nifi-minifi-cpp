...
class ExecutePythonScript : public core::Processor {
 public:
  explicit ExecutePythonScript(std::string name, const utils::Identifier &uuid = {})
 ...
 private:
  std::shared_ptr<core::logging::Logger> logger_ = core::logging::LoggerFactory<ExecutePythonScript>::getLogger(uuid_);
