...
std::shared_ptr<utils::IdGenerator> GetMovementSensors::id_generator_ = utils::IdGenerator::getIdGenerator();
...
void GetMovementSensors::onSchedule(const std::shared_ptr<core::ProcessContext> &context, const std::shared_ptr<core::ProcessSessionFactory> &sessionFactory) {
