...
TEST_CASE("Compress Codec property") {
  ...
  test_controller.getProcessor()->setProperty(PublishKafka::ClientName.name, "test_client");
  test_controller.getProcessor()->setProperty(PublishKafka::SeedBrokers.name, "test_seedbroker");
  test_controller.getProcessor()->setProperty(PublishKafka::Topic.name, "test_topic");
  test_controller.getProcessor()->setProperty(PublishKafka::MessageTimeOut.name, "10ms");
