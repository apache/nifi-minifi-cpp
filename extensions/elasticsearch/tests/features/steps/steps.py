...
def step_impl(context: MinifiTestContext, doc_id: str, index: str, value: str, field: str):
    assert context.containers["elasticsearch"].check_elastic_field_value(index_name=index, doc_id=doc_id, field_name=field, field_value=value)
...
def step_impl(context: MinifiTestContext, doc_id: str, index: str, value: str, field: str):
    assert context.containers["opensearch"].check_elastic_field_value(index_name=index, doc_id=doc_id, field_name=field, field_value=value)
