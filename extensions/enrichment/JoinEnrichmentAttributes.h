...
using StoredFlowFileMap = std::unordered_map<std::string, api::core::StashedFlowFile, utils::string::transparent_string_hash, std::equal_to<>>;

class JoinEnrichmentAttributes : public api::core::ProcessorImpl {
 public:
 ...
 private:
  ...
  void handleFlowFile(api::core::FlowFile flow_file, api::core::ProcessSession& session, std::chrono::steady_clock::time_point current_time);
  static void join(api::core::FlowFile& original, api::core::FlowFile& enrichment, api::core::ProcessSession& session);
