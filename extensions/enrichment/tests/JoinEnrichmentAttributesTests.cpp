...
namespace org::apache::nifi::minifi::enrichment::test {
TEST_CASE("JoinEnrichmentAttributes input without appropriate attributes") {
  minifi::test::SingleProcessorTestController controller(minifi::test::utils::make_custom_c_processor<JoinEnrichmentAttributes>(
      core::ProcessorMetadata{utils::Identifier{}, "JoinEnrichmentAttributes", logging::LoggerFactory<JoinEnrichmentAttributes>::getLogger()}));
  const auto trigger_result = controller.trigger("test_content");
...
TEST_CASE("JoinEnrichmentAttributes invalid role") {
  minifi::test::SingleProcessorTestController test_controller(minifi::test::utils::make_custom_c_processor<JoinEnrichmentAttributes>(
      core::ProcessorMetadata{utils::Identifier{}, "JoinEnrichmentAttributes", logging::LoggerFactory<JoinEnrichmentAttributes>::getLogger()}));
