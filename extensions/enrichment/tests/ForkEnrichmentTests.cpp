...
TEST_CASE("Fork Enrichment processor works") {
  minifi::test::SingleProcessorTestController test_controller(minifi::test::utils::make_custom_c_processor<ForkEnrichment>(
      core::ProcessorMetadata{utils::Identifier{}, "ForkEnrichment", logging::LoggerFactory<ForkEnrichment>::getLogger()}));
