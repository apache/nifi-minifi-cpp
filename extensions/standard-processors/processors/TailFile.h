...
class TailFile : public core::Processor {
 public:
  ...
  EXTENSIONAPI static constexpr auto InitialStartPosition = core::PropertyDefinitionBuilder<magic_enum::enum_count<InitialStartPositions>()>::createProperty("Initial Start Position")
      ...
      .build();
  EXTENSIONAPI static constexpr auto AttributeProviderService = core::PropertyDefinitionBuilder<0, 0, 0, utils::meta::type_list<minifi::controllers::AttributeProviderService>>::
      createProperty("Attribute Provider Service")
