...
class ListenUDP : public NetworkListenerProcessor {
 public:
  ...
  EXTENSIONAPI static constexpr auto PortOutputAttribute = core::OutputAttributeDefinition<0>{"udp.port", {}, "The listening port on which the messages were received."};
