...
TEST_CASE("ListenSyslog without parsing test", "[ListenSyslog]") {
  ...
  SECTION("UDP") {
    ...
    protocol = "UDP";
    CHECK_THAT(utils::sendUdpDatagram(rfc5424_logger_example_1, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(invalid_syslog, endpoint).ec, MatchesSuccess());
  }
...
TEST_CASE("ListenSyslog with parsing test", "[ListenSyslog][NetworkListenerProcessor]") {
  ...
  SECTION("UDP") {
    ...
    CHECK_THAT(utils::sendUdpDatagram(rfc5424_doc_example_1.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc5424_doc_example_2.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc5424_doc_example_3.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc5424_doc_example_4.unparsed_, endpoint).ec, MatchesSuccess());

    CHECK_THAT(utils::sendUdpDatagram(rfc3164_doc_example_1.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc3164_doc_example_2.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc3164_doc_example_3.unparsed_, endpoint).ec, MatchesSuccess());
    CHECK_THAT(utils::sendUdpDatagram(rfc3164_doc_example_4.unparsed_, endpoint).ec, MatchesSuccess());
