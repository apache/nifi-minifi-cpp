...
class PrometheusChecker:
    ...
    def _verify_queue_metrics(self) -> bool:
        return self._verify_metrics_exist(
            [
                "minifi_queue_data_size",
                "minifi_queue_data_size_max",
                "minifi_queue_size",
                "minifi_queue_size_max",
            ],
            "QueueMetrics",
        )
    ...
    def _verify_general_processor_metrics(
        ...
        return self._verify_metrics_exist(
            [
                "minifi_average_onTrigger_runtime_milliseconds",
                ...
                "minifi_incoming_bytes",
                "minifi_bytes_read",
                "minifi_bytes_written",
            ],
            metric_class,
            labels,
        ) and self._verify_metrics_larger_than_zero(
            [
                "minifi_onTrigger_invocations",
                "minifi_transferred_flow_files",
                "minifi_transferred_to_success",
    ...
    def _verify_flow_information_metrics(self) -> bool:
        return self._verify_metrics_exist(
            [
                ...
                "minifi_bytes_read",
                "minifi_bytes_written",
                "minifi_flow_files_in",
                "minifi_flow_files_out",
                "minifi_bytes_in",
                "minifi_bytes_out",
                "minifi_invocations",
                "minifi_processing_nanos",
    ...
    def _verify_device_info_node_metrics(self) -> bool:
        return self._verify_metrics_exist(
            [
                "minifi_physical_mem",
                "minifi_memory_usage",
                "minifi_cpu_utilization",
                "minifi_cpu_load_average",
            ],
            "DeviceInfoNode",
        )
