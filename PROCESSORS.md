...
|SAS Token|||Shared Access Signature token. Specify either SAS Token (recommended) or Account Key together with Storage Account Key if Managed Identity is not used.<br/>**Supports Expression Language: true**|
