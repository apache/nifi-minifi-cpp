...
| **Upload Bandwidth Limit**                      | 0 B                      |                             | Maximum data per second to send, use 0 for unlimited.                                                                                                                                                                                                                                                           |
| **Download Bandwidth Limit**                    | 0 B                      |                             | Maximum data per second to receive, use 0 for unlimited.                                                                                                                                                                                                                                                        |
