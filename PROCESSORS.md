...
| **Upload Speed Limit**                      | 0 B                      |                             | Maximum data per second to send, use 0 for unlimited.                                                                                                                                                                                                                                                           |
| **Download Speed Limit**                    | 0 B                      |                             | Maximum data per second to receive, use 0 for unlimited.                                                                                                                                                                                                                                                        |
