...
class MinifiWithYamlConfig(MinifiContainer):
    def __init__(self, config_dir, name, vols, network, image_store, command=None):
        super().__init__(config_dir, name, vols, network, image_store, command, engine='minifi-cpp-with-yaml-config')
        self.serializer = Minifi_flow_yaml_serializer()