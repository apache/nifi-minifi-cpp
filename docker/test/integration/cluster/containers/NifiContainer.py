...
class NifiContainer(FlowContainer):
    ...
    def __init__(self, context, config_dir, name, vols, network, image_store, command=None):
        if not command:
        ...
        super().__init__(context, config_dir, name, 'nifi', vols, network, image_store, command)
