...
def step_impl(context, directory):  # noqa: F811
...
def step_impl(context, processor_type, property, property_value, cluster_name):  # noqa: F811
...
def step_impl(context, processor_type, property, property_value):  # noqa: F811
...
def step_impl(context, cluster_name):  # noqa: F811
    cluster = context.test.acquire_cluster(cluster_name)
...
def step_impl(context, address):  # noqa: F811
...
def step_impl(context, property_name, processor_name, property_value):  # noqa: F811
...
def step_impl(context, processor_name, sceduling_period):  # noqa: F811
    processor = context.test.get_node_by_name(processor_name)
...
def step_impl(context, relationship, source_name, remote_process_group_name):  # noqa: F811
...
def step_impl(context, relationship, source_name, destination_name):  # noqa: F811
    source = context.test.get_node_by_name(source_name)
...
def step_impl(context, content, path):  # noqa: F811
...
def step_impl(context, cluster_name, source_name, port):  # noqa: F811
...
def step_impl(context, cluster_name, relationship, source_name, destination_name):  # noqa: F811
    cluster = context.test.acquire_cluster(cluster_name)
...
def step_impl(context, producer_name, consumer_name):  # noqa: F811
    cert, key = gen_cert()
...
def step_impl(context, content, duration):  # noqa: F811
...
def step_impl(context, duration):  # noqa: F811
...
def step_impl(context, cluster_name, content_type):  # noqa: F811
