...
class WindowsContainer(ContainerProtocol):
    ...
    def deploy(self, context: MinifiTestContext | None) -> bool:
        ...
        for directory in self.dirs:
            ...
            # usage of os.sep ensures we use host-native separators for the temp setup
    ...
    def exec_run(self, command: Union[str, list]) -> Tuple[int | None, str]:
        ...
        if self.container:
            ...
            # errors='replace' handles non-utf8 characters often found in Windows logs
    ...
    def get_logs(self) -> str:
        ...
        # Windows logs may contain mixed encodings; replace errors to avoid crash
