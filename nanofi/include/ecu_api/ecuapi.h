...
typedef int (*on_start_callback_t)(ecu_context_t * ecu_ctx, io_type_t input,
    io_type_t output, properties_t * input_props, properties_t * output_props);
...
ecu_context_t * create_ecu(io_context_t * io, const char * name, const char * strm_name,
    input_context_t *ip, output_context_t * op);
