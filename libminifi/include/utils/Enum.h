...
template<typename T>
T enumCast(std::string_view str, std::optional<T> fallback = std::nullopt, bool case_insensitive = false) {
  ...
  throw std::runtime_error("Cannot convert \"" + std::string(str) + "\" to enum class value");
}
