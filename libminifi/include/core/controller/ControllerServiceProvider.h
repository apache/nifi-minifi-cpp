...
class ControllerServiceProvider : public CoreComponent, public ConfigurableComponent, public ControllerServiceLookup {
 public:
   ...
   * @param serviceNode controller service node.
   */
  virtual std::future<utils::ComplexTaskResult> enableControllerService(std::shared_ptr<ControllerServiceNode> &serviceNode) = 0;
   ...
   * @param serviceNode controller service node.
   */
  virtual std::future<utils::ComplexTaskResult> disableControllerService(std::shared_ptr<core::controller::ControllerServiceNode> &serviceNode) = 0;
