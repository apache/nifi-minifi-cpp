...
class SiteToSiteProvenanceReportingTask : public minifi::RemoteProcessGroupPort {
 public:
  ...
  static std::string getJsonReport(core::ProcessContext& context, core::ProcessSession& session, const std::vector<std::shared_ptr<provenance::ProvenanceEventRecord>> &records); // NOLINT
