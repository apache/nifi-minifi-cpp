...
class TestServer {
 public:
  TestServer(const std::string &port, const std::string &rooturi, CivetHandler *handler, CivetCallbacks *callbacks, const std::string& cert, const std::string &ca_cert) {
