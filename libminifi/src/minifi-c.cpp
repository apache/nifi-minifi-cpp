...
MinifiExtension* MinifiCreateExtension(MinifiExtensionContext* extension_context, const MinifiExtensionCreateInfo* extension_create_info) {
  ...
  auto* extension = reinterpret_cast<minifi::core::extension::Extension::Context*>(extension_context)->create(org::apache::nifi::minifi::core::extension::Extension::Info{
...
MinifiStatus MinifiRegisterProcessor(MinifiExtension* extension, const MinifiProcessorClassDefinition* processor) {
  ...
  auto extension_info = reinterpret_cast<org::apache::nifi::minifi::core::extension::Extension*>(extension)->getInfo();
  if (!extension_info) {
...
MinifiStatus MinifiProcessContextGetControllerService(
  ...
  if (const minifi::utils::CControllerService* c_controller_service = dynamic_cast<minifi::utils::CControllerService*>(&*service_shared_ptr)) {
    ...
    if (class_description.name == toStringView(controller_service_type)) {
