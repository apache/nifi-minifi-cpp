...
const std::unordered_map<std::string_view, gsl::not_null<const core::PropertyValidator*>> Configuration::CONFIGURATION_PROPERTIES{
  ...
  {Configuration::nifi_content_repository_lmdb_max_db_size, gsl::make_not_null(&core::StandardPropertyValidators::DATA_SIZE_VALIDATOR)},
  {Configuration::nifi_flowfile_repository_lmdb_max_db_size, gsl::make_not_null(&core::StandardPropertyValidators::DATA_SIZE_VALIDATOR)},
