...
Property ExecuteProcess::Command(
    "Command",
    ...
    "");
Property ExecuteProcess::CommandArguments(
    "Command Arguments",
...
void ExecuteProcess::onTrigger(ProcessContext *context,
