...
void ThreadedSchedulingAgent::schedule(std::shared_ptr<core::Processor> processor) {
  ...
  auto processContext = std::make_shared<core::ProcessContext>(processor_node, controller_service_provider_, repo_, flow_repo_, meta_info_container_, content_repo_);
