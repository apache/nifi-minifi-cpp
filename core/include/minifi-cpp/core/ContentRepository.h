 ...
 */
class ContentRepository : public virtual core::CoreComponent, public virtual StreamManager<minifi::ResourceClaim>, public virtual utils::EnableSharedFromThis<ContentRepository>, public virtual core::RepositoryMetricsSource {
 public:
